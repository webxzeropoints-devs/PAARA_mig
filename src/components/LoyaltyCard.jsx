  ...
  return (
    <svg viewBox="0 0 90 90" className="paara-stamp-mark">
      ...
      <g filter={`url(#paara-rough-${index})`} fill="none" stroke={colors.roseDark} strokeWidth="2">
        ...
        <text x="45" y="52" textAnchor="middle" fontFamily="BrilliantCut, cursive" fontSize="22" fill={colors.roseDark} stroke="none">paara</text>
      </g>
    </svg>
  );
}
